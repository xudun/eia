layui.use(['jquery', 'layer'], function() {
    ...
    $(function(){
        ...
        var active = {
            //机构考核人员详情
            save: function () {
                //  var actionUrl = "/jobRating/jobRatingScoreSave";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(docWidth<=973){
                    $("#personTable").css("width",docWidth-661+"px");
                }else{
                    $("#personTable").css("width",docWidth-851+"px");
                }
                var width = total*81
                ...
                if(data.total>0){
                    ...
                    for(var i in jobRatingList) {
                        ...
                        if(data.showType){
                            ...
                            jobSkill.append('<td width="80px"><input type="text" name="jobSkill" value="'+jobRatingCore.jobSkill+'" /></td>')
                            ...
                            cultureCognition.append('<td width="80px"><input type="text" name="cultureCognition" value="'+jobRatingCore.cultureCognition+'" /></td>')
                        }else{
                            ...
                            jobSkill.append('<td width="80px"><input type="text" name="jobSkill" value="" /></td>')
...
function empComment(eiaHrEvalScoreDetailId){
    layui.use( 'layer', function() {
        var layer = layui.layer;
