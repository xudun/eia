layui.use(['jquery', 'layer','form'], function() {
    ...
    var active = {
        //机构考核人员详情
        save: function () {
            var actionUrl = "/eia/eiaHrEvalScore/eiaHrEvalScoreAssSave";
    ...
    $.ajax({
     //   url:"/eia/static/js/layuiFrame/data/assEdit.json",
        url:"/eia/eiaHrEvalScore/eiaHrEvalAssList?eiaHrEvalScoreId="+eiaHrEvalScoreId,
    ...
    $("#assComment").click(function(){
        var staffId = $("#staffId").val();
        var jobRatingType = $("#jobRatingType").val();
        var assessmentMonth = $("#assessmentMonth").text();
        var orgId  = $("#orgId").val();
        var pageUrl = "/eia/eiaHrEvalScoreDetail/eiaHrEvalComment?staffId="+staffId+"&jobRatingType="+jobRatingType+"&assessmentMonth="+assessmentMonth+"&orgId="+orgId
        layer.open({
            type : 2,
            title :" ",
            maxmin: true,
    ...
    $(".staffName").click(function(){
        ...
        layer.open({
            ...
            content: pageUrl,
            min: function () {
                $(".layui-layer-title").text("助理打分详细表");
            },
            restore: function () {
                $(".layui-layer-title").text(" ");
            }
