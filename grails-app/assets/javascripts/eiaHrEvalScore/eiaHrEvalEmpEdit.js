layui.use(['jquery', 'layer','form'], function() {
    ...
    $("#empComment").click(function(){
        ...
        var orgId  = $("#orgId").val();
        var pageUrl = "/eia/eiaHrEvalScoreDetail/eiaHrEvalComment?staffId="+staffId+"&jobRatingType="+jobRatingType+"&assessmentMonth="+assessmentMonth+"&orgId="+orgId+"&eiaHrEvalScoreId="+eiaHrEvalScoreId
        layer.open({
            type : 2,
            title :" ",
            maxmin: true,
