layui.use(['jquery', 'layer', 'table'], function () {
    ...
    if (oid != null && oid != '') {
        ...
        table.render({
            id: 'eiaProPlanItemList',
            elem: '#eiaProPlanItemList',
            url: '/eia/eiaProjectPlan/getProjectNodeListNew?proPlanId=' + $('#proPlanId').val(),
            toolbar: ' ',
            defaultToolbar:['filter', 'print', 'exports'],
            cols: [[
                {fixed: 'left', title: '序号', width: "6%", align: "center", templet: "#indexTable"},
    ...
    table.on('tool(eiaProPlanItemList)', function (obj) {
        ...
        if (obj.event === 'planItemEdit') {
            var nodesName = data.nodesName;
                pageUrl = '/eia/eiaProject/eiaProPlanItemEdit?nodesName=' + nodesName;
