layui.use(['jquery', 'layer', 'form','table'], function () {
    ...
    var startDate = getParamFromUrl(document.location.href, "startDate");
    if (!startDate) {
        startDate = "";
    }
    var endDate = getParamFromUrl(document.location.href, "endDate");
    if (!endDate) {
        endDate = "";
    }
    ...
    table.render({
        id: 'eiaProjectList',
        elem: '#eiaProjectList',
        url: '/eia/eiaAnalysis/eiaProjectQuery?viewType=' + viewType + '&startDate=' + startDate + '&endDate=' + endDate + '&inputUserId=' + inputUserId + '&inputDeptId=' + inputDeptId,
        toolbar: '#tableTopTmp',
