...
<head>
    ...
    <asset:javascript src="/eiaInvoice/eiaInvoiceReveCreate.js"/>
    <style>
...
<div class="layui-fluid larry-wrapper pt0">
    <div class="layer-title">
        <fieldset class="layui-elem-field layui-field-title site-title">
            <legend id="title">
                <a name="methodRender" class="pageTitle">新增开票</a>
            </legend>
        </fieldset>
    </div>

    <form class="layui-form offerInfo">
        <input type="hidden" id="clientConfigId" name="clientConfigId" value="">
        ...
        <div align="center">
            <div class="layui-form-item mt15">
                ...
                （<g:radio name="billOrg" value="联合赤道" />联合赤道&nbsp;&nbsp;&nbsp;
                 <g:radio name="billOrg" value="联合泰泽" checked="true" />联合泰泽）
                </font>
            </div>
        ...
        <div class="layui-row mt15">
            <div class="layui-col-xs6">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="invoiceType" lay-filter="invoiceType"  id="zyfp" value="增值税专用发票" title="增值税专用发票 "checked>
                ...
                <div class="layui-form-item has-tag">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="clientName" name="clientName"  class="layui-input readonly"  lay-verify="required" value="" readonly>
                    </div>
                ...
                <div class="layui-form-item verify-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="taxRegCode" name="taxRegCode" class="layui-input readonly" lay-verify="required"readonly>
                    </div>
                </div>
                <div class="layui-form-item verify-item">
                    <label class="layui-form-label"><span class="col-f00">* </span>开户行</label>
                    <div class="layui-input-block">
                        <input type="text" id="bankName" name="bankName" class="layui-input readonly" lay-verify="required" readonly>
                    </div>
                </div>
                <div class="layui-form-item verify-item">
                    <label class="layui-form-label"><span class="col-f00">* </span>开户行户名</label>
                    <div class="layui-input-block">
                        <input type="text" id="bankAccount" name="bankAccount" class="layui-input readonly" lay-verify="required" readonly>
                    </div>
                </div>
            ...
            <div class="layui-col-xs6">
                <div class="layui-form-item has-tag">
                    ...
                    <div class="layui-input-block">
                        <input type="number" id="billMoney" step='0.0001' name="billMoney" class="layui-input" lay-verify="required">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="estimateDateS" name="estimateDateS" class="layui-input" lay-verify="required|date" placeholder="年-月-日" autocomplete="off" value="">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span class="col-f00">* </span>申请开票时间</label>
                    <div class="layui-input-block">
                        <input type="text" id="billDateS" name="billDateS" class="layui-input" lay-verify="required|date" placeholder="年-月-日" autocomplete="off" value="">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span class="col-f00">* </span>实际收款情况</label>
                    <div class="layui-input-block">
                        <input type="radio" name="realMoney" value="已进账" title="已进账"checked="true">
                        <input type="radio" name="realMoney" value="未进账" title="未进账" checked>
                    </div>
                </div>
                <div class="layui-form-item has-tag">
                    <label class="layui-form-label"><span class="col-f00">* </span>地址及电话</label>
                    <div class="layui-input-block">
                        <input type="text" id="addrTel" name="addrTel" class="layui-input readonly" lay-verify="required" readonly>
                    </div>
                </div>
                <div class="layui-form-item has-tag">
                    <label class="layui-form-label"><span class="col-f00">* </span>开票类别</label>
                    <div class="layui-input-block">
                        <input type="radio" name="billType" value="咨询费" title="咨询费">
                        <input type="radio" name="billType" value="其他" title=" 其他" checked>
                    </div>
                </div>
                <div class="layui-form-item">
