...
<head>
    ...
    <asset:javascript src="/eiaHrEvalScoreDetail/eiaHrEvalDMToEmpInput.js"/>
    <asset:stylesheet src="/eiaHrEval/eiaHrEvalDMToEmpInput.css"/>
        ...
        <div id="personTable" class="float-left mb15" style="overflow-x:auto">
            <form id="perTableForm">
                ...
                <table id="perTable" class="eiaHrEvalTable">
                    ...
                    <tr class="lessThan20" id="jobSkill">
                    </tr>
