...
<head>
    ...
    <asset:javascript src="/eiaAnalysis/eiaProjectList.js"/>
</head>
...
<div class="table-top">
    <div class="layui-inline">
        <div class="layui-input-inline">
            <input type="text" name="projectName" value="" id="projectName" placeholder="项目名称、项目编号" class="layui-input larry-search-input w400">
        </div>
