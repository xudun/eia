...
<head>
    ...
    <asset:javascript src="/eiaHrEvalScore/eiaHrEvalScoreEmp.js"/>
    <asset:stylesheet src="/eiaHrEval/eiaHrEvalDMToEmpDetail.css"/>
</head>
...
<div class="layui-fluid larry-wrapper">
    ...
    <div id="eiaHrEvalTable" class="mt100 font12">
        ...
        <div id="personTable" class="float-left mb15" style="overflow-x:auto">
            <input type="hidden"   id="eiaHrEvalScoreId"  name="eiaHrEvalScoreId" value="" />
