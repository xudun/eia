...
<head>
    ...
    <asset:javascript src="/eiaHrEvalScore/eiaHrEvalAssEdit.js"/>
    <asset:stylesheet src="/eiaHrEval/eiaHrEvalAssEdit.css"/>
        ...
        <div id="personTable" class="float-left mb15" style="overflow-x:auto">
            <form id="perTableForm">
                ...
                <table class="eiaHrEvalTable" id="rightTitle">
                    <tr class="titleTop display-none pt15 pr1">
                        ...
                        <th width="81px"><a href="#" class="staffName"></a> </th>
                    </tr>
                    <tr class="mt1">
                        <th width="81px"><a href="#" class="staffName"></a> </th>
                    </tr>
                ...
                <table id="perTable" class="eiaHrEvalTable">
                    <tr class="lessThan10">
                        <td width="81px"><input type="text" name="teamSpirit" id="teamSpirit" value="" /></td>
                    </tr>
                    <tr class="lessThan10">
                        <td width="81px"><input type="text" name="leadership" id="leadership" value="" /></td>
                    </tr>
                    <tr class="lessThan10">
                        <td width="81px"><input type="text" name="proAbility" id="proAbility" value="" /></td>
                    </tr>
                    <tr class="lessThan20">
                        <td width="81px"><input type="text" name="workExecution" id="workExecution" value="" /></td>
                    </tr>
                    <tr class="lessThan20">
                        <td width="81px"><input type="text" name="performance" id="performance" value="" /></td>
                    </tr>
                    <tr class="lessThan20">
                        <td width="81px"><input type="text" name="workingAttitude" id="workingAttitude" value="" /></td>
                    </tr>
                    <tr class="lessThan10">
                        <td width="81px"><input type="text" name="leadershipManager" id="leadershipManager" value="" /></td>
                    </tr>
                    <tr >
                        <th><input type="text" disabled name="finalScore" ></th>
                    </tr>
                    <tr>
                        <td id="scoreId"><button type="button" class="remarkButton" id="assComment">员工评语</button></td>
                    </tr>
                </table>
            </form>
        </div>
