        ...
        <div class="mt20">
            <div class="float-left">
                <table class="eiaHrEvalTable">
                    ...
                    <tr>
                        <th width="49px" rowspan="12">工<br>作<br>绩<br>效</th>
                        <th width="109px" rowspan="4">工作执行力</th>
                        <th width="49px" rowspan="4">20</th>
                        <th width="79px">18-20分</th>
                        <th width="499px">执行能力强，积极主动完成工作任务</th>
                    </tr>
                    <tr>
                        <th>15-17分</th>
            ...
            <div class="float-left">
                <table class="eiaHrEvalTable" id="perTable">
                    ...
                    <tr>
                        <td width="80px"><input type="text" id="workExecution" name="workExecution" disabled value="" /></td>
                    </tr>
                    <tr>
                        <td width="80px"><input width="80px" type="text" disabled id="performance" name="performance" value="" ></td>
                    </tr>
                    <tr>
                        <td width="80px"><input width="80px" type="text" disabled id="jobSkill" name="jobSkill" value="" ></td>
                    </tr>
                    <tr>
                        <td width="80px"><input width="80px" type="text" disabled id="workingAttitude" name="workingAttitude"/></td>
                    </tr>
                    <tr>
                        <td width="80px"><input width="80px" type="text" disabled id="teamSpirit" name="teamSpirit" value="" ></td>
                    </tr>
                    <tr>
                        <td width="81px"><input width="81px" type="text" disabled id="cultureCognition" name="cultureCognition" value="" ></td>
                    </tr>
                    <tr>
