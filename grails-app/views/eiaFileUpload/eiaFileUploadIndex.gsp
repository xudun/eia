...
<script type="text/html" id="tableTopTmp">
    <div class="layui-btn-group pl12">
        ...
        <g:if test="${itemMap?.keySet().contains(WorkFlowConstants.NODE_CODE_XCKC)}">
        ...
        <g:if test="${itemMap?.keySet().contains(WorkFlowConstants.NODE_CODE_YS)}">
            <a class="layui-btn pl12 eiaProject display-none" lay-event="firstInsPrint" data-type="firstInsPrint"><i class="larry-icon">&#xe89a;</i> ${itemMap[WorkFlowConstants.NODE_CODE_YS]}打印</a>
        </g:if>
        <g:if test="${itemMap?.keySet().contains(WorkFlowConstants.NODE_CODE_ES)}">
            <a class="layui-btn pl12 eiaProject display-none" lay-event="SecondInsPrint" data-type="SecondInsPrint"><i class="larry-icon">&#xe89a;</i> ${itemMap[WorkFlowConstants.NODE_CODE_ES]}打印</a>
        </g:if>
        <g:if test="${itemMap?.keySet().contains(WorkFlowConstants.NODE_CODE_SS)}">
            <a class="layui-btn pl12 eiaProject display-none" lay-event="ThirdInsPrint" data-type="ThirdInsPrint"><i class="larry-icon">&#xe89a;</i> ${itemMap[WorkFlowConstants.NODE_CODE_SS]}打印</a>
        </g:if>
