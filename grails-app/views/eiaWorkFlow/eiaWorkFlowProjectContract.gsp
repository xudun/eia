...
<div class="layui-fluid larry-wrapper pt0 ">
    <form class="layui-form flow-confirm">
        ...
        <div class="layui-row mt15">
            <div class="layui-col-xs6">
                ...
                <div class="layui-form-item" id="contractSelect">
                    <label class="layui-form-label"><span class="col-f00">*</span>关联合同</label>

                    <div class="layui-input-block">
                        <select name="contractId" id="contractId" lay-filter="contractId" lay-verify="required"
                                lay-search>
                            <option value="">请选择</option>
                        </select>
                    </div>
        ...
        <input type="hidden" name="eiaContractId" id="eiaContractId">
    </form>
</div>
...
<asset:javascript src="/eiaWorkFlow/eiaWorkFlowProjectContract.js"/>
</body>
</html>