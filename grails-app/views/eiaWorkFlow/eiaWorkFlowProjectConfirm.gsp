...
<div class="layui-fluid larry-wrapper pt0">
    ...
    <form class="layui-form flow-confirm">
        ...
        <div class="layui-row mt15">
            ...
            <div class="layui-col-xs6">
                <div class="layui-form-item proMonBlock">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="userNamesDept" name="userNamesDept" class="layui-input" lay-verify="required" readonly>
                        <input type="hidden" id="userNames" name="userNames" value="">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label"><span class="col-f00">*</span>实际结束时间</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><span class="col-f00">*</span>提交内容</label>

            <div class="layui-input-block">
                <textarea name="opinion" id="opinion" placeholder="请输入提交内容" class="layui-textarea"
