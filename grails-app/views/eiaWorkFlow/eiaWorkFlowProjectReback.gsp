...
<head>
    ...
    <asset:stylesheet src="/eiaWorkFlow/eiaWorkFlowProjectReback.css"/>
</head>
<body class="pb68">
<div class="layui-fluid larry-wrapper pt0 ">
    <div class="layer-title ">
        <fieldset class="layui-elem-field layui-field-title site-title">
            <legend>
                <a name="methodRender" class="pageTitle">流程返回</a>
            </legend>
        </fieldset>
    </div>
        ...
        <blockquote class="layui-elem-quote larry-btn fixed-footer">
            <div class="layui-inline pl12">
                <div class="layui-btn-group top-group">
                    <button class="layui-btn pl12" lay-submit="" lay-filter="save"><i class="larry-icon">&#xe830;</i> 提交</button>
                </div>
            </div>
        </blockquote>
...
<asset:javascript src="/eiaWorkFlow/eiaWorkFlowProjectReback.js"/>
</body>
</html>