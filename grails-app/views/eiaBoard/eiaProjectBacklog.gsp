...
<head>
    ...
    <asset:javascript src="/eiaBoard/eiaProjectBacklog.js"/>
</head>
...
<div class="layui-inline">
    <div class="layui-input-inline">
        <input type="text" name="workFlowName" value="" id="workFlowProjectTitle" placeholder="审批标题、创建人" class="layui-input larry-search-input">
    </div>
</div>
