                        ...
                        <section class="layui-card">
                            ...
                            <div class="layui-card-body larryms-shortcut">
                                <ul class="layui-row layui-col-space10 shortcut-group shortcut-lf">
                                    ...
                                    <li class="layui-col-xs2">
                                        <a larry-tab="iframe" data-name="EIA_XMGL_NBCS_ADDSELF"  data-url='${HttpUrlConstants.EIA_FORWARD_JUMP}eiaProjectExplore/eiaProjectExploreIndex?ifAdd=1' data-id="larry-85" data-group="0" data-icon="larry-xiangmuguanli" data-font="larry-icon">
                                            <i class="larry-icon">&#xe981;</i>
                                            <cite>项目初审创建</cite>
                                        </a>
                                    </li>
