...
<head>
    ...
    <asset:javascript src="/eiaBoard/eiaProjectExpBacklog.js"/>
</head>
...
<!--内审页签的查询框-->
    ...
    <div class="layui-inline">
        <div class="layui-input-inline">
            <input type="text" name="workFlowName" value="" id="workFlowProjectExploreTitle" placeholder="审批标题、创建人" class="layui-input larry-search-input">
        </div>
    </div>
