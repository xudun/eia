...
<head>
    ...
    <asset:javascript src="/eiaProject/eiaProjectPlanDetail.js"/>
...
<div class="layui-btn-group">
    <a class="layui-btn layui-btn-normal layui-btn-sm" lay-event="itemDetail" title="查看流程详情"><i class="larry-icon">&#xe896;</i></a>
</div>
</script>
