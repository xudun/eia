...
<head>
    ...
    <asset:javascript src="/eiaPlatForm/eiaAreaInfoIndex.js"/>
</head>
<body>
<div class="layui-fluid larry-wrapper pt0">
    ...
    <div class="layui-col-lg12 layui-col-md12 layui-col-sm12 layui-col-xs12">
        <table id="eiaAreaInfoList" lay-filter="eiaAreaInfoList"></table>
    </div>
...
<script type="text/html" id="eiaAreaInfoListTool">
...
<div class="table-top">
    <div class="layui-inline">
        <div class="layui-input-inline">
            <input type="text" name="projectName" value="" id="projectName" placeholder="区域/企业名称" class="layui-input larry-search-input">
        </div>
    </div>
