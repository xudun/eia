...
<head>
    ...
    <asset:javascript src="/eiaTask/eiaTaskEdit.js"/>
</head>
<body>
...
%{--
                <button type="resetBtn" class="layui-btn layui-btn-primary"><i class="larry-icon">&#xe69a;</i> 重置</button>
--}%
            </div>
        </blockquote>
